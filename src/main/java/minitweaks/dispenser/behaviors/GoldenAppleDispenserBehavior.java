...
public class GoldenAppleDispenserBehavior extends OptionalDispenseItemBehavior {
    protected ItemStack execute(BlockSource blockSource, ItemStack stack) {
        ...
        List<ZombieVillager> list = blockSource.level().getEntities(EntityTypes.ZOMBIE_VILLAGER, new AABB(blockPos), EntitySelector.LIVING_ENTITY_STILL_ALIVE.and((entity) -> {
