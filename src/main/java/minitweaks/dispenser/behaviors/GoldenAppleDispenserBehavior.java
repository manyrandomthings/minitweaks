...
public class GoldenAppleDispenserBehavior extends FallibleItemDispenserBehavior {
    protected ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
        ...
        List<ZombieVillagerEntity> list = pointer.world().getEntitiesByClass(ZombieVillagerEntity.class, new Box(blockPos), EntityPredicates.VALID_LIVING_ENTITY.and((entity) -> {
        ...
        if(!list.isEmpty()) {
            ...
            ZombieVillagerEntity zombieVillager = Util.getRandom(list, pointer.world().getRandom());
            // set converting
